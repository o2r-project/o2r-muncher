...
module.exports.maybeDelete = function (domainId) {
    Publisher.findOne({urls: domainId}, (err, publisher) => {
        if (!publisher) {
            Domain.findByIdAndDelete(domainId);
        }
    });
}
