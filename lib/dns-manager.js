...
module.exports.addToDns = function (entityId, priority) {
    ...
    instance.findOne({id: entityId}, (err, entity) => {
        ...
        Dns.findOne({'urls': entity.urls, priority: priority}, (err, dns) => {
            if (err) {
                ...
                if (!dns) {
                    ...
                    createDnsServer(entity.id, entity.urls, priority);
                } else {
...
createDnsServer = function (entityId, entityUrls, priority) {
